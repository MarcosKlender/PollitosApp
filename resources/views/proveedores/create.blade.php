                ...
                <div class="card-body">
                    ...
                    <form method="post" action="{{ route('proveedores.store') }}">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control" id="pro_ruc" name="pro_ruc" value="{{ old('pro_ruc') }}"
                        ...
                        <div class="form-group">
                            ...
                            <input type="email" class="form-control" id="pro_email" name="pro_email" value="{{ old('pro_email') }}"
                                required />
                        </div>
