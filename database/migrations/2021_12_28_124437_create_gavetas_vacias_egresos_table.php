...
class CreateGavetasVaciasEgresosTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('gavetas_vacias_egresos', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('gavetas_vacias_egresos');
    }
}
